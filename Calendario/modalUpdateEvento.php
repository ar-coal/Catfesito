<div class="modal" id="modalUpdateEvento" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      $usr = $_GET["usuario"];
      if ($usr != "Admin") {
        echo '<form name="formEventoUpdate" id="formEventoUpdate" action="UpdateEventoUsr.php" class="form-horizontal" method="POST">';
      } else {
        echo '<form name="formEventoUpdate" id="formEventoUpdate" action="UpdateEvento.php" class="form-horizontal" method="POST">';
      }
      ?>
      
      <input id="usuario" name="usuario" type="hidden" value= <?php $usr = $_GET["usuario"];echo $usr;?>>
        ...
        <div class="modal-footer">
          <button type="submit" class="btn btn-success">Guardar Cambios Evento</button>

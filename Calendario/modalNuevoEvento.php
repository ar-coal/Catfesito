  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Registrar Reservacion</h5>
      ...
      $usr = $_GET["usuario"];
      if ($usr != "Admin") {
        echo '<form name="formEvento" id="formEvento" action="nuevoEventoUsr.php" class="form-horizontal" method="POST">';
      } else {
        echo '<form name="formEvento" id="formEvento" action="nuevoEvento.php" class="form-horizontal" method="POST">';
      }
      ?>
        <input id="usuario" name="usuario" type="hidden" value= <?php
      $usr = $_GET["usuario"];echo $usr;?>>
        ...
        <div class="form-group">
          <label for="fecha_fin" class="col-sm-12 control-label">fecha_fin</label>
          <div class="col-sm-10">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="hora" id="hora" placeholder="10:00">
          </div>
        </div>
